...
const Search = [
  ...
  { value: 'Active', label: 'Search by e-mail' },
  { value: 'Passive', label: 'Search by phone number' }
];
const ClientType = [
  { value: 'All', label: 'Select client type' },
  { value: 'Active', label: 'Personal' },
  { value: 'Passive', label: 'Legal Entity' }
];
// ----------------------------------------------------------------------
      ...
      <Container>
        ...
        <Stack mb={5} flexDirection="row" alignItems="center" justifyContent="space-around">
          ...
          <Stack mb={5} justifyContent="space-around">
            ...
            <BlogPosts options={ClientType} icon={FormatListNumberedIcon} />
          </Stack>
          <Stack mb={5} justifyContent="space-around">
            <Typography variant="body1" gutterBottom>
              Country
            </Typography>
            <BlogPosts options={Court} />
          </Stack>
        </Stack>
        ...
        <Stack direction="row" alignItems="center" justifyContent="flex-end" mt={-6} pb={7} pr={4}>
          <Button
            variant="contained"
            component={RouterLink}
            to="#"
            sx={{ backgroundColor: '#b2b9bf' }}
            startIcon={<Icon icon={baselineCreditScore} />}
          >
            Apply
          </Button>
        </Stack>
